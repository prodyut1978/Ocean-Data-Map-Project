...
class ONav_Profiling_Driver():
    ...
    def __init__(self, base_url, config_url, csv_file, prof_path, user_id, max_attempts = 3, max_time = 120):
        ...
        self.log_filename = f'/dev/shm/{self.user_id}_api_profiling_{self.format_time(self.start_time)}.log'
        self.results = []
...
if __name__ == '__main__':
    ...
    config = '/home/on/Ocean-Data-Map-Project/scripts/performance_testing/test_config.json'
    csv_file = '/home/on/Ocean-Data-Map-Project/api_profiling_results.csv'#None
